  ...
  readonly roadmapGroups: RoadmapGroup[] = [
    {
      ...
      items: [
        {
          label: 'Tema dinâmico',
          description: 'provideGemsTheme, paletas e runtime',
          icon: 'fa-solid fa-palette',
          route: '/showcase/resources/theming',
        },
        {
          label: 'Tokens de design',
          description: 'Variáveis CSS, espaçamento e tipografia',
    ...
    },
    {
      ...
      items: [
        {
          label: 'Input Text',
          description: 'Texto, e-mail, número, tel, url',
          icon: 'fa-solid fa-i-cursor',
          route: '/showcase/input-text',
        },
        {
          label: 'Select',
          description: 'Dropdown nativo acessível',
          icon: 'fa-solid fa-chevron-down',
          route: '/showcase/select',
        },
        {
          label: 'Textarea',
          description: 'Multilinha com auto-resize',
          icon: 'fa-solid fa-align-left',
          route: '/showcase/textarea',
        },
        {
          label: 'Field Error',
          description: 'Mensagens de validação PT-BR',
          icon: 'fa-solid fa-triangle-exclamation',
          route: '/showcase/field-error',
        },
        {
          label: 'Form Card',
          description: 'Agrupamento e seção de ações',
    ...
    },
    {
      ...
      items: [
        {
          label: 'Botões',
          description: 'Classes .btn-* e gems-button',
    ...
    },
    {
      ...
      items: [
        {
          label: 'Table',
          description: 'Paginação, ordenação e seleção',
          icon: 'fa-solid fa-table',
          route: '/showcase/search',
        },
        {
          label: 'Card List Select',
          description: 'Seleção visual em cards',
          icon: 'fa-solid fa-grip',
          route: '/showcase/list-select',
        },
        {
          label: 'Badge',
          description: 'Rótulos de status coloridos',
          icon: 'fa-solid fa-tag',
          route: '/showcase/badge',
        },
        {
          label: 'Empty State',
          description: 'Tela vazia com ação opcional',
    ...
    },
    {
      ...
      items: [
        {
          label: 'Alerts',
          description: 'Diálogos SweetAlert2',
        ...
        {
          label: 'Modal',
          description: 'Diálogo com backdrop e ESC',
          icon: 'fa-solid fa-window-restore',
          route: '/showcase/modal',
        },
        {
          label: 'Loading Full',
          description: 'Spinner de tela cheia',
          icon: 'fa-solid fa-spinner',
          route: '/showcase/loading/full-page',
        },
        {
          label: 'Loading Skeleton',
          description: 'Placeholder enquanto carrega',
    ...
    },
    {
      ...
      items: [
        {
          label: 'Side Menu',
          description: 'Menu lateral colapsável',
          icon: 'fa-solid fa-sidebar',
          route: '/showcase/side-menu',
        },
        {
          label: 'Tabs',
          description: 'Navegação por abas acessível',
          icon: 'fa-solid fa-folder',
          route: '/showcase/tabs',
        },
        {
          label: 'Wizard',
          description: 'Fluxo passo a passo',
          icon: 'fa-solid fa-list-check',
          route: '/showcase/wizard',
        },
        {
          label: 'File Upload',
          description: 'Upload com S3 e preview',
    ...
    },
    {
      ...
      items: [
        {
          label: 'Instalação',
          description: 'Como configurar a SDK no seu projeto',
          icon: 'fa-solid fa-download',
          route: '/showcase/resources/installation',
        },
        {
          label: 'Integração IA',
          description: 'Contexto para Claude, Cursor e afins',
    ...
    },
    {
      ...
      description:
        'HTTP, autenticação, serviços e configuração — partes não-visuais da biblioteca.',
      icon: 'fa-solid fa-gear',
      type: 'resource',
      items: [
        {
          label: 'HTTP / BaseStore',
          description: 'GemsBaseStore, GEMS_API_URL e Pageable',
          icon: 'fa-solid fa-server',
          route: '/showcase/resources/base-store',
        },
        {
          label: 'Loading Interceptor',
          description: 'gemsLoadingInterceptor + GemsLoadingService',
          icon: 'fa-solid fa-circle-notch',
          route: '/showcase/resources/http-loading',
        },
        {
          label: 'Serviços utilitários',
          description: 'Navigation, Session, S3, Alert',
          icon: 'fa-solid fa-toolbox',
          route: '/showcase/resources/services',
        },
        {
          label: 'Auth & Keycloak',
          description: 'gemsRoleGuard + *HasRole directive',
