...
- `gems-table` mantém `aria-sort` no cabeçalho da coluna e usa um botão nativo para ordenar. Isso preserva o nome e o teclado do comando sem atribuir `role="button"` ao cabeçalho.
